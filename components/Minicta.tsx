  ...
  return (
    <div className='bg-[#262c29]'>
        ...
        <div className='w-11/12 mx-auto flex flex-col gap-y-8'> 
            ...
            <h2 className={`${fraunces.className} md:text-[1.45rem] font-light capitalize`}>Subscribe to our weekly newsletter for curated architectural, interior, designs delivered to your inbox</h2>
        </div>
