  ...
  return (
    <div className='pt-20 '>
        <div className='px-6 pt-5 pb-20 bg-[#3a423e] flex flex-col gap-y-6'>
            <div className='py-4'>
                <h2 className={`${fraunces.className} text-white text-2xl md:text-4xl font-extrabold pb-2`}>Explore.</h2>
            ...
            <Link href="/" className="cursor-pointer font-semibold text-[#898e8c] uppercase text-sm md:text-base">
              Magazine
            </Link>
